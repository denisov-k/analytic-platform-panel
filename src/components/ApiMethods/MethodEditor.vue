<template>
    <form>
        ...
        <div class="uk-margin-small">
            ...
            <div class="uk-form-controls">
                <div class="uk-inline uk-display-block">
                    <input class="uk-input" :class="{ 'uk-form-danger': $v.entity.rowLimit.$error }" type="number" placeholder="" v-model="$v.entity.rowLimit.$model">
                </div>
            </div>
        </div>
        <v-collapse-group :onlyOneActive="false">
            <v-collapse-wrapper class="uk-margin-small" :active="dimensionCollapseActive" @onStatusChange="(data) => dimensionCollapseActive = data.status">
                <div>
                    <span class="icon">
                    ...
                    <vk-dropdown class="uk-border-rounded">
                        <ul class="uk-nav uk-dropdown-nav">
                            <li><a @click="onParamAddBtnClick(entity.dimensions, 'id')"><div class="icon uk-margin-small-right"><i class="mdi mdi-pound mdi-18px"></i></div>ID</a></li>
                            <li><a @click="onParamAddBtnClick(entity.dimensions, 'expression')"><div class="icon uk-margin-small-right"><i class="mdi mdi-variable mdi-18px"></i></div>Expression</a></li>
                        </ul>
                    </vk-dropdown>
                </div>
                <div v-collapse-content>
                    <vk-grid class="uk-flex-middle uk-margin-small-top" gutter="collapse" v-for="(item, i) in $v.entity.dimensions.$each.$iter" :key="i">
        ...
        <v-collapse-group :onlyOneActive="false">
            <v-collapse-wrapper class="uk-margin-small" :active="measureCollapseActive" @onStatusChange="(data) => measureCollapseActive = data.status">
                <div>
                    <span class="icon">
                    ...
                    <vk-dropdown class="uk-border-rounded">
                        <ul class="uk-nav uk-dropdown-nav">
                            <li><a @click="onParamAddBtnClick(entity.measures, 'id')"><div class="icon uk-margin-small-right"><i class="mdi mdi-pound mdi-18px"></i></div>ID</a></li>
                            <li><a @click="onParamAddBtnClick(entity.measures, 'expression')"><div class="icon uk-margin-small-right"><i class="mdi mdi-variable mdi-18px"></i></div>Expression</a></li>
                        </ul>
                    </vk-dropdown>
                </div>
                <div v-collapse-content>
                    <vk-grid class="uk-flex-middle uk-margin-small-top" gutter="collapse" v-for="(item, i) in $v.entity.measures.$each.$iter" :key="i">
                        <div class="uk-width-expand">
                            <input class="uk-input uk-form-small" :class="{ 'uk-form-danger': item.name.$error }" type="text" placeholder="Название" v-model="item.name.$model">
                        </div>
                        <div class="uk-width-auto">
